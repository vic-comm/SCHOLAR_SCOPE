...
//   return  ( <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between border-b border-slate-200/80 bg-background-light/80 px-4 backdrop-blur-sm dark:border-slate-800/80 dark:bg-background-dark/80 lg:gap-8">
//       <div className="flex items-center gap-3">
//         <a className="flex items-center gap-2" href="#">
//           <span className="material-symbols-outlined text-3xl text-primary">school</span>
//           <h1 className="hidden text-xl font-bold text-slate-900 dark:text-slate-50 md:block">ScholarScope</h1>
//         </a>
//       </div>
...
//           <span className="material-symbols-outlined absolute left-3 text-slate-500 dark:text-slate-400">search</span>
//           <input
//             type="text"
//             value={query}
...
//             type="button"
//             onClick={handleReset}
//             className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 transition"
//           >
...
//         <a className="hidden rounded-lg px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 dark:text-slate-200 dark:hover:bg-slate-800 sm:block" href="/dashboard">Dashboard</a>
//         <a className="hidden rounded-lg px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 dark:text-slate-200 dark:hover:bg-slate-800 sm:block" href="#">Update Profile</a>
//         <a className="hidden rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 sm:block" href="/login">Sign Out</a>
//       </div>
//     </header>
//   );
// };
