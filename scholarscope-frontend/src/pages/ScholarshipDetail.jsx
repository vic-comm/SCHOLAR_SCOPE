...
// import api from '../api'
// import { Bookmark, Heart, Share2, ArrowLeft, ChevronDown, ExternalLink, Calendar, DollarSign} from "lucide-react";
...
//                 await api.post(`/scholarships/${id}/unsave/`)
...
export default function ScholarshipDetail() {
    ...
    async function handleApply() {
        // Open scholarship link in new tab
        if (scholarship.link) {
        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-800 dark:text-slate-200 min-h-screen">
            ...
            <main className="max-w-5xl mx-auto px-6 py-10">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-10">
                    ...
                    >
                        <Bookmark className={scholarship.is_bookmarked ? "fill-primary" : ""} />
                    </button>
                    ...
                    <button 
                        ...
                        title={scholarship.is_saved ? "Unsave scholarship" : "Save scholarship"}
                    >
                        <Heart className={scholarship.is_saved ? "fill-primary" : ""} />
                    </button>
